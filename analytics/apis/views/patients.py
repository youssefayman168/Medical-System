...
def get_patients(request):
        ...
        # Query the database
        current_month_count = Paitent.objects.filter(added_at__range=(current_month_start, current_month_end)).count()
        previous_month_count = Paitent.objects.filter(added_at__range=(previous_month_start, previous_month_end)).count()
